...
*/
/**************************************************************************/
static uint8_t write_i2c_register(uint8_t addr, uint8_t reg, uint8_t val) {
  Wire.beginTransmission(addr);
  Wire._I2C_WRITE((byte)reg);
...
*/
/**************************************************************************/
bool RTC_DS3231::begin(uint8_t sda, uint8_t scl) {
  Wire.begin(sda, scl);
...
*/
/**************************************************************************/
int RTC_DS3231::adjust(const DateTime &dt) {
  Wire.beginTransmission(DS3231_ADDRESS);
  ...
  int ret = write_i2c_register(DS3231_ADDRESS, DS3231_STATUSREG, statreg);
  return ret;
}
